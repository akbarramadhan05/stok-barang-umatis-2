-- Import INI setelah database "stokbar_umatis" sudah dibuat di phpMyAdmin
-- Langkah: klik stokbar_umatis (kiri) -> tab SQL -> paste isi file ini -> Go
...
INSERT IGNORE INTO suppliers (id, name, phone, email, address, categories, notes) VALUES
